...
def receive_code(request):
    ...
    # 改成自己的回调地址
    redirect_uri = "https://webapp.yuanheci.site/settings/qq/receive_code"  # 此处不用处理网址中的特殊字符
    ...
    params = {
        ...
        'client_id': "102628960",                # 填入APP ID
        'client_secret': "Ul3DDygFe2NYaSH1",     # 填入APP Key
        'code': code,
    ...
    params = {
        'access_token': access_token,
        'oauth_consumer_key': "102628960",      # 填入APP ID
        'openid': openid
    }
